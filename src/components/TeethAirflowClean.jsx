        ...
        <div className='2xl:mt-[128px] xl:my-[100px] sm:my-[64px] my-[48px] 2xl:mb-[173px]'>
            <div className="container 2xl:max-w-[1544px] mx-auto px-6">
                <div className="flex justify-center lg:justify-between flex-wrap mb-[48px] sm:mb-[58px] md:mb-[68px] xl:mb-[128px] relative">
                    ...
                    <div className="xl:w-[45%] 2xl:w-[46%] flex items-center order-1 xl:order-0 mt-[35px] sm:mt-[50px] md:mt-[100px] xl:mt-0">
                        <div className="relative z-20 mt-5">
                            ...
                            <p className='font-medium ff_anvir text-grey text-base sm:text-xl md:text-2xl 2xl:max-w-[648px] mb-[20px] md:mb-[30px] xl:mb-[50px] 2xl:mb-[61px] !leading-normal '>The dentist will first remove tartar using traditional methods and then finish with Airflow as a last thorough touch. The treatment removes discoloration and biofilm (i.e. the layer of bacteria which is also called plaque when the biofilm is in the mouth).</p>
                    ...
                    <div className="xl:w-1/2 w-full relative flex justify-center xl:justify-end z-10 order-0 xl:order-1">
                        <div className="relative z-10  md:mt-[38px]">
                            <img src={whiteTeethCircle} alt="whiteTeethCircle" className="lg:max-w-[183px] lg:h-[183px] absolute z-20 animate-spin top-[12%] w-[121px] h-[121px] sm:w-[183.95px] sm:h-[183.95px] left-[-4%] pointer-events-none"></img>
